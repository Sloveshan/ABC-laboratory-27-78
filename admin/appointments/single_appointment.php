            ...
            <div class="dashboard_content" id="dashboard_content">
                <div class="dashboard_header">
                    ...
                    <div>
                        ...
                        <a href="appointment_report.php?appointment_id=<?php echo $row['appointment_id']; ?>" class="btn btn-success">Extract Report</a>
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">Appointment was created/updated on</th>
