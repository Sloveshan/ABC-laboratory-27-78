...
if ($result->num_rows == 1) {
    ...
    echo "Error: Doctor details not found.";
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($update_stmt->execute()) {
        header('location:doctor_page.php?success=Password updated successfully.');
        exit;
    } else {
...
<div class="dashboard_content" id="dashboard_content">
    ...
    <a href="doctor_page.php" class="btn btn-secondary mt-3">Cancel</a>
</form>
    </div>
</div>
