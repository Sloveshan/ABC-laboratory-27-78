...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_stmt->bind_param("si", $hashed_password, $technician_id);

    if ($update_stmt->execute()) {
        header('location:technician_page.php?success=Password updated successfully.');
        exit;
    } else {
...
<div class="dashboard_content" id="dashboard_content">
    ...
    <input type="hidden" name="doctor_id" value="<?php echo $technician_details['id']; ?>">
